...
?>
    ...
    <div class=" w3-sidebar w3-bar-block w3-card w3-animate-left" style="background-color:rgb(35,35,35); color:white; padding:5px;" id="leftMenu">
      ...
      <a href="#" class="w3-bar-item w3-button" style="text-decoration:none;" id="active1"><i class="iconmenu fa fa-home" style="color:red;"></i>  &nbsp;   Home</a>
      <a href="#" class="w3-bar-item w3-button" style="text-decoration:none;"><i class="iconmenu fa fa-fire" ></i>  &nbsp;    Trending</a>
      <a href="#" class="w3-bar-item w3-button" style="text-decoration:none;"><i class="iconmenu fa fa-music"></i>  &nbsp;    My songs</a><hr>
      <div style="padding:5px; color:grey;">OPTIONS</div>
      <a href="#" class="w3-bar-item w3-button"  data-toggle="modal" data-target="#Modal"  style="text-decoration:none;"><i class="iconmenu fa fa-upload"></i> &nbsp;  Upload</a>
      <a href="#" class="w3-bar-item w3-button"  style="text-decoration:none;"><i class="iconmenu fa fa-book"></i> &nbsp;   Albums</a>
      <?php 
      ...
      ?>
      <a href="#" class="w3-bar-item w3-button" style="text-decoration:none;"><i class="iconmenu fa fa-edit"></i> &nbsp;   Edit song details</a>
    </div>
